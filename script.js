...
function showCategory(category) {
  const items = menu[category].map(([name, price, photo]) => {
    ...
    if (photo) {
      ...
      img.src = `assets/donuts/${photo}?v=transparent-2`;
      img.alt = '';
      img.loading = 'lazy';
      main.append(img);
    }
