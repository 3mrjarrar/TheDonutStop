...
for (const [route, file] of [['/', 'dist/index.html'], ['/menu', 'dist/menu/index.html'], ['/404', 'dist/404.html']]) {
...
console.log('Prerendered home, menu and 404. Deploy dist as static files.');
