...
for (const file of ['migrations/202609170001_catalog.sql','seed.sql','migrations/202609170002_admin_inventory.sql']) await db.exec(readFileSync(new URL('../'+file,import.meta.url),'utf8'));
